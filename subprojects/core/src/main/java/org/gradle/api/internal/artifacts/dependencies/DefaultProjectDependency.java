...
public class DefaultProjectDependency extends AbstractModuleDependency implements ProjectDependencyInternal {
    ...
    public ProjectComponentIdentifier getProjectComponentIdentifier() {
        return dependencyProject.getOwner().getComponentIdentifier();
    }
    ...
    public Set<File> resolve(boolean transitive) {
        ...
        DeprecationLogger.deprecate("Directly resolving a project dependency")
            .withAdvice("Add the dependency to a resolvable configuration and resolve that configuration instead.")
            .willBecomeAnErrorInGradle9()
            .withUpgradeGuideSection(8, "directly_resolving_project_dependencies")
            .nagUser();
    ...
    public TaskDependencyInternal getBuildDependencies() {
        ...
        DeprecationLogger.deprecate("Accessing the build dependencies of a project dependency")
            .withAdvice("Add the dependency to a resolvable configuration and query the configuration's build dependencies.")
            .willBecomeAnErrorInGradle9()
            .withUpgradeGuideSection(8, "directly_resolving_project_dependencies")
            .nagUser();
