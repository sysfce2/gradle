...
public class AccessTrackingProperties extends Properties {
    ...
    @Override
    @Nullable  // The contract here is trickier - the return value is only null if the default value is null, but this methog is not really part of any public API.
