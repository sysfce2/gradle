...
public class DefaultJavaToolchainProvisioningService implements JavaToolchainProvisioningService {
    ...
    public static final String AUTO_DETECTION_TOOLCHAIN_HINT = "Learn more about toolchain auto-detection at " + Documentation.userManual("toolchains", "sec:auto_detection").getUrl() + ".";
    public static final String DOWNLOAD_REPOSITORIES_TOOLCHAIN_HINT = "Learn more about toolchain repositories at " + Documentation.userManual("toolchains", "sub:download_repositories").getUrl() + ".";
    ...
    public File tryInstall(JavaToolchainSpec spec) {
        ...
        if (repositories.isEmpty()) {
            throw new ToolchainDownloadFailedException("No locally installed toolchains match and toolchain download repositories have not been configured.",
                AUTO_DETECTION_TOOLCHAIN_HINT,
                DOWNLOAD_REPOSITORIES_TOOLCHAIN_HINT);
        }
